...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Data Selection
load(epochProcessFile)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% build Stim Ranks
num_stimuli = size(Stimulations_names,1);
...
[~,num_participants_F,participants_del_Total] = eyeAnalysisDataExtract(1,Stimuli_Data_Corr_Mean,Stimuli_ranks);
...
[X_Corr_DataSelected_Means,X_Uncorr_DataSelected_Means,X_Uncorr_DataSelected,X_Corr_DataSelected,X_Perc_DataSelected,X_Perc_DataSelected_Means,COND,SUBJECTS]...
    = eyeAnalysisDataPreProcess(num_participants_F,Stimuli_Data_Corr_Mean,Stimulations_Data_UnCorr_Mean,Stimuli_Data_Perc_Mean,Stimuli_ranks,1,participants_del_Total);
...
[xPercSD,xPercCIAbove,xPercCIBelow,xCorrSD,xCorrCIAbove,xCorrCIBelow,xUncorrSD,xUncorrCIAbove,xUncorrCIBelow] = ...
    eyeAnalysisCurveCalc(zScore,X_Perc_DataSelected,X_Perc_DataSelected_Means,X_Corr_DataSelected_Means,X_Uncorr_DataSelected_Means,num_participants_F,X_Corr_DataSelected,X_Uncorr_DataSelected);
...
[F_Sign,F,xPercMeans,p_time,F_time,p_sign] = eyeAnalysisCompMobileAvg(X_Perc_DataSelected,COND,SUBJECTS,alphaReal,num_participants_F);
